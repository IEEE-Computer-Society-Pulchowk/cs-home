        ...
        <footer className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <a
                                    href="mailto:pulchowkcompsbc@gmail.com"
                                    className="hover:text-white transition-colors"
                                >
                                    pulchowkcompsbc@gmail.com
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="flex space-x-4 pt-2">
                            <a
                                ...
                                className="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noreferrer"
                            >
                                <FaFacebook size={20} />
                            </a>
                            <a
                ...
                <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
                    <p>
                        &copy; {new Date().getFullYear()} IEEE Computer Society Pulchowk SBC. All rights reserved.
                    </p>
