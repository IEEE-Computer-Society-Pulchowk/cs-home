      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <Link
              href="/team"
              className="text-ieee-cs-orange font-semibold hover:underline inline-flex items-center"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              { icon: FaUsers, label: "Active Members", value: "50+" },
              { icon: FaBolt, label: "Annual Events", value: "15+" },
